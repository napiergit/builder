"""
OAuth configuration for google integration.
...
class OAuthConfig:
    ...
    def __init__(self):
        ...
        if not self.redirect_uri:
            base_url = os.getenv('MCP_SERVER_BASE_URL', 'https://your-server.com')
    ...
    def get_client_config(self) -> Dict[str, Any]:
        ...
        if not self.is_configured():
            raise ValueError(
                "OAuth not configured. Please set CLIENT_ID and CLIENT_SECRET "
